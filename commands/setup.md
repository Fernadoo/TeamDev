...
## Step 2: Set Up Codex Plugin

teamdev's review-gate and issue-triage skills depend on the Codex plugin for adversarial code review. Fetch and read the setup instructions at:

https://github.com/openai/codex-plugin-cc/blob/main/README.md

Follow the instructions there to install and configure the Codex plugin before proceeding.
...
## Step 4: Offer First Project Setup
